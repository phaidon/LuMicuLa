	...
	$.sceditor = function (el, options) {
		...
		base.wysiwygEditorInsertText = function (text, endText) {
			var escape = function(str) {
                ...
                return base.options.getTextHandler(str);
...
function editorquote(quote, author) {

    // first get the editor's instance
    var editor = jQuery("#message").data("sceditor");

    // execute the quote command
    editor.commands.quote.exec.call(editor, null, quote, author);
